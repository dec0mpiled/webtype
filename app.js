...
if (app.get('env') === 'development') {
  ...
  var PRIVATE_KEY  = process.env.PRIVATE_KEY;   // Keymetrics Private key
  var PUBLIC_KEY   = process.env.PUBLIC_KEY;   // Keymetrics Public  key
  ...
  pm2.connect(function() {
    pm2.start({
      script    : 'app.js',
      name      : 'webtype',     // ----> THESE ATTRIBUTES ARE OPTIONAL:
